    ...
    return (
        <div className="relative flex min-h-screen w-full items-center justify-center overflow-hidden bg-black text-white selection:bg-purple-500/30">
            ...
            <Empty className="relative z-10">
                <EmptyHeader>
                    <EmptyTitle className="font-[Horizon] font-extrabold text-4xl md:text-7xl whitespace-nowrap bg-gradient-to-b from-white via-zinc-200 to-zinc-600 bg-clip-text text-transparent tracking-tighter drop-shadow-2xl">
                        It&#39;s not you, it&#39;s us.
                    </EmptyTitle>

                    <EmptyDescription className="text-zinc-400 text-lg md:text-xl leading-relaxed mt-4 whitespace-nowarp">
                        We encountered an error while processing your request. <br className="hidden md:block" />
                        Please try again later. If it&#39;s still not fixed, contact the developers.
                    </EmptyDescription>
                </EmptyHeader>
